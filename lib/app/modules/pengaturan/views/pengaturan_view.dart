              ...
              Obx(
                () => GSCardColumn(
                  children: [
                    ...
                    8.height,
                    // Input Jam Masuk PIKET
                    GSTextField(
                      label: "Waktu Masuk Piket".tr,
                      icon: Icon(Icons.cleaning_services_outlined),
                      controller: controller.piketTimeInC,
                      isEnabled: controller.isEdit,
                      onTap: () async {
                        var time = await controller.pickTime(
                            context, controller.selectedPiketTimeIn.value);
                        if (time is TimeOfDay) {
                          controller.selectedPiketTimeIn.value = time;
                          controller.piketTimeInC.text =
                              timeFormatter(timeToDate(time));
                        }
                      },
                    ),
